...
par(mfcol = c(2,2))
plot(subset_by_date$date_and_time, subset_by_date$Global_active_power, type = "l", xlab = "", 
...
plot(subset_by_date$date_and_time, subset_by_date$Sub_metering_1, type = "l", xlab = "",
        ...
        r <- as.POSIXct(round(range(subset_by_date$date_and_time), "days"))
        axis.POSIXct(1, at = seq(r[1], r[2], by = "day"), format = "%a")
plot(subset_by_date$date_and_time, subset_by_date$Voltage, type = "l", xlab = "datetime", 
             ylab = "Voltage", xaxt = "n")
        r <- as.POSIXct(round(range(subset_by_date$date_and_time), "days"))
        axis.POSIXct(1, at = seq(r[1], r[2], by = "day"), format = "%a")
plot(subset_by_date$date_and_time, subset_by_date$Global_reactive_power, type = "l", xlab = "datetime", 

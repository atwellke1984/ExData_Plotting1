...
## Create a line graph for the Global Active Power Data over date and time and save it to a PNG file 

png(filename = "plot2.png")
plot(subset_by_date$date_and_time, subset_by_date$Global_active_power, 
     type = "l",
     xlab = "",
